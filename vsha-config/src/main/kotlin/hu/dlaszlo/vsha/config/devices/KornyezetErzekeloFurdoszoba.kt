...
@Component("kornyezetErzekeloFurdoszoba")
class KornyezetErzekeloFurdoszoba : AbstractDeviceConfig() {

    data class DeviceState(
        val mqttName: String = "ambs5",
        val name: String = "Környezet érzékelő - fürdőszoba"
    )
    ...
    companion object {
        val logger = LoggerFactory.getLogger(KornyezetErzekeloFurdoszoba::class.java)!!
    }
}