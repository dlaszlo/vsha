...
import hu.dlaszlo.vsha.config.ErzekeloMozgasFolyoso
...
@RestController
@RequestMapping("api/erzekeloMozgasFolyoso")
class ErzekeloMozgasFolyosoController : ErzekeloMozgasFolyoso() {
