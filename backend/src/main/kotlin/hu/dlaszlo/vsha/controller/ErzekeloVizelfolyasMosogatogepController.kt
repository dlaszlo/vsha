...
import hu.dlaszlo.vsha.config.ErzekeloVizelfolyasMosogatogep
...
@RestController
@RequestMapping("api/erzekeloVizelfolyasMosogatogep")
class ErzekeloVizelfolyasMosogatogepController : ErzekeloVizelfolyasMosogatogep() {
